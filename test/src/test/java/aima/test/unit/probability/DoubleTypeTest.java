...
public class DoubleTypeTest {
	...
	public void testIsZero2() {
		ProbabilityNumber testValue0 = ProbabilityFactory.doubleValueOf(0);
		assertEquals(testValue0.isZero(), true);
	}
	...
	public void testIsOne2() {
		ProbabilityNumber testValue1 = ProbabilityFactory.doubleValueOf(1);
		assertEquals(testValue1.isOne(), true);
	}
	...
	public void testIfEquals2() {
		ProbabilityNumber testValue2 = ProbabilityFactory.doubleValueOf(0.15);
		ProbabilityNumber testValue4 = ProbabilityFactory.doubleValueOf(0.1499999999);
		assertEquals(testValue2.equals(testValue4), true);
	}
	
	@Test
	public void testIfEquals3() {
		ProbabilityNumber testValue2 = ProbabilityFactory.doubleValueOf(0.1);
		ProbabilityNumber testValue4 = ProbabilityFactory.doubleValueOf(0.23);
	...
	public void testIfValid1() {
		...
		ProbabilityNumber testValue1 = ProbabilityFactory.doubleValueOf(0.8);
		ProbabilityNumber testValue2 = ProbabilityFactory.doubleValueOf(0.7);
	...
	public void testIfValid2() {
		...
		ProbabilityNumber testValue1 = ProbabilityFactory.doubleValueOf(0.8);
		ProbabilityNumber testValue2 = ProbabilityFactory.doubleValueOf(0.7);
		ProbabilityNumber testValue3 = ProbabilityFactory.doubleValueOf(0.5);
