...
public class ConvertToConjunctionOfClausesTest {
	...
	public void testSymbolTransform() {
		...
		ConjunctionOfClauses transformed = ConvertToConjunctionOfClauses.apply(symbol);
	...
	public void testBasicSentenceTransformation() {
		...
		ConjunctionOfClauses transformedAnd = ConvertToConjunctionOfClauses.apply(and);
		Assert.assertEquals("{{A}, {B}}", transformedAnd.toString());

		Sentence or = parser.parse("A | B");
		ConjunctionOfClauses transformedOr = ConvertToConjunctionOfClauses.apply(or);
		Assert.assertEquals("{{A, B}}", transformedOr.toString());

		Sentence not = parser.parse("~C");
		ConjunctionOfClauses transformedNot = ConvertToConjunctionOfClauses.apply(not);
	...
	public void testImplicationTransformation() {
		...
		ConjunctionOfClauses transformedImpl = ConvertToConjunctionOfClauses.apply(impl);
	...
	public void testBiConditionalTransformation() {
		...
		ConjunctionOfClauses transformedBic = ConvertToConjunctionOfClauses.apply(bic);
	...
	public void testTwoSuccessiveNotsTransformation() {
		...
		ConjunctionOfClauses transformed = ConvertToConjunctionOfClauses.apply(twoNots);
		Assert.assertEquals("{{A}}", transformed.toString());
	}
	...
	public void testThreeSuccessiveNotsTransformation() {
		...
		ConjunctionOfClauses transformed = ConvertToConjunctionOfClauses.apply(threeNots);
		Assert.assertEquals("{{~A}}", transformed.toString());
	}
	...
	public void testFourSuccessiveNotsTransformation() {
		...
		ConjunctionOfClauses transformed = ConvertToConjunctionOfClauses.apply(fourNots);
		Assert.assertEquals("{{A}}", transformed.toString());
	}
	...
	public void testDeMorgan1() {
		...
		ConjunctionOfClauses transformed = ConvertToConjunctionOfClauses.apply(dm);
	...
	public void testOrDistribution1() {
		...
		ConjunctionOfClauses transformed = ConvertToConjunctionOfClauses.apply(or);
	...
	public void testAimaExample() {
		...
		ConjunctionOfClauses transformed = ConvertToConjunctionOfClauses.apply(aimaEg);
	...
	public void testNested() {
		...
		ConjunctionOfClauses transformed = ConvertToConjunctionOfClauses.apply(nested);
		Assert.assertEquals("{{A, B, C, D}, {A, B, C, E}}", transformed.toString());
		
		nested = parser.parse("A | (B | (C & (D & E)))");
		transformed = ConvertToConjunctionOfClauses.apply(nested);
	...
	public void testIssue78() {
		...
		ConjunctionOfClauses transformed = ConvertToConjunctionOfClauses.apply(issue78Eg);
