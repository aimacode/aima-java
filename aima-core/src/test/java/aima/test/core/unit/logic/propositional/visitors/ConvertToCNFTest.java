...
import aima.core.logic.propositional.transformations.ConvertToCNF;
...
public class ConvertToCNFTest {
	...
	public void testSymbolTransform() {
		...
		Sentence transformed = ConvertToCNF.apply(symbol);
	...
	public void testImplicationTransformation() {
		...
		Sentence transformedImpl = ConvertToCNF.apply(impl);
	...
	public void testBiConditionalTransformation() {
		...
		Sentence transformedBic = ConvertToCNF.apply(bic);
	...
	public void testTwoSuccessiveNotsTransformation() {
		...
		Sentence transformed = ConvertToCNF.apply(twoNots);
		Assert.assertEquals("A", transformed.toString());
	}
	...
	public void testThreeSuccessiveNotsTransformation() {
		...
		Sentence transformed = ConvertToCNF.apply(threeNots);
		Assert.assertEquals("~A", transformed.toString());
	}
	...
	public void testFourSuccessiveNotsTransformation() {
		...
		Sentence transformed = ConvertToCNF.apply(fourNots);
		Assert.assertEquals("A", transformed.toString());
	}
	...
	public void testDeMorgan1() {
		...
		Sentence transformed = ConvertToCNF.apply(dm);
	...
	public void testOrDistribution1() {
		...
		Sentence transformed = ConvertToCNF.apply(or);
	...
	public void testAimaExample() {
		...
		Sentence transformed = ConvertToCNF.apply(aimaEg);
	...
	public void testIssue78() {
		...
		Sentence transformed = ConvertToCNF.apply(issue78Eg);
	...
	public void testDistributingOrCorrectly() {
		...
		Sentence transformed = ConvertToCNF.apply(s);
