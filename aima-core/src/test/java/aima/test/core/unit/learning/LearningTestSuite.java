...
import aima.test.core.unit.learning.neural.ActivationFunctionTest;
...
@RunWith(Suite.class)
@Suite.SuiteClasses({ActivationFunctionTest.class, DataSetTest.class, InformationAndGainTest.class,
