...
public class HiererchicalSearch {
	  ...
	  static String[] hla=new String[100]; //to  store next hla
	  static String[] storePrefixSuffix=new String[100];
	  static String[] storeOutcome=new String[100];
	  static String returnPlan=new String("Home"); //to store plan
	  /**
	   * 
