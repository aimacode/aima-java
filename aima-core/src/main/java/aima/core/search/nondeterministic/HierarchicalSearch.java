...
class problem //class for storing the problem
{
    ...
    {
        FileReader f=new FileReader("src/main/resources/aima/core/learning/data/problem.txt");
...
public class HierarchicalSearch
{
    ...
    public void set()throws IOException
    {
        ...
        p.input();
        f=new FileReader("src/main/resources/aima/core/learning/data/input.txt");
