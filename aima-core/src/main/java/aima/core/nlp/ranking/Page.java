...
public class Page {
	...
	public boolean setContent( String content ) { this.content = content; return true; }
	
	public List<String> getInlinks() { return linkedFrom; }
	
	public List<String> getOutlinks() { return linkTo; }
}
