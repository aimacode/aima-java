...
public class ParticleSet {
	 ...
	 * 	return generateParticleSetForPredictedState(r).perceptionUpdate(perception,
	 * 			r);
	 * }
	 * 
	 * public ParticleSet filter(String action, String perception, Randomizer r) {
	 * 	return generateParticleSetForPredictedState(action, r).perceptionUpdate(
	 * 			perception, r);
	 * }
	 * 
	 ...
	 * }
	 * 
	 * public VarDistribution toRandomVariable() {
	 ...
	 * 	}
	 * 
	 * 	VarDistribution result = new VarDistribution(states);
