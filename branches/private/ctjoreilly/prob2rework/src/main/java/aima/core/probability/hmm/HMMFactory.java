...
public class HMMFactory {
	 ...
	 * 	// possible actions.
	 * 
	 * 	List&lt;String&gt; states = Arrays.asList(new String[] { HmmConstants.DOOR_OPEN,
	 ...
	 * 
	 * 	VarDistribution prior = new VarDistribution(states);
	 ...
	 * 
	 * 	tm.setTransitionProbability(HmmConstants.DOOR_OPEN, HmmConstants.PUSH_DOOR,
	 * 			HmmConstants.DOOR_OPEN, 1.0);
	 * 	tm.setTransitionProbability(HmmConstants.DOOR_OPEN, HmmConstants.PUSH_DOOR,
	 * 			HmmConstants.DOOR_CLOSED, 0.0);
	 * 	tm.setTransitionProbability(HmmConstants.DOOR_CLOSED,
	 ...
	 * 	List&lt;String&gt; states = Arrays.asList(new String[] { HmmConstants.RAINING,
	 ...
	 * 	tm.setTransitionProbability(HmmConstants.RAINING, HmmConstants.NOT_RAINING,
	 * 			0.3);
	 * 	tm.setTransitionProbability(HmmConstants.NOT_RAINING, HmmConstants.RAINING,
	 * 			0.3);
	 ...
	 * 	// sm.setSensingProbaility(state,perception,p); given a state the
	 * 	// probability of a perception is p
	 * 	sm.setSensingProbability(HmmConstants.RAINING, HmmConstants.SEE_UMBRELLA,
	 * 			0.9);
