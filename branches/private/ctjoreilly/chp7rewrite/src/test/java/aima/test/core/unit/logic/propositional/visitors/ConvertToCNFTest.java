...
public class ConvertToCNFTest {
	...
	public void testSymbolTransform() {
		...
		ConjunctionOfClauses transformed = ConvertToCNF.convert(symbol);
	...
	public void testBasicSentenceTransformation() {
		...
		ConjunctionOfClauses transformedAnd = ConvertToCNF.convert(and);
		Assert.assertEquals("(A) & (B)", transformedAnd.toString());

		Sentence or = parser.parse("A | B");
		ConjunctionOfClauses transformedOr = ConvertToCNF.convert(or);
		Assert.assertEquals("(A | B)", transformedOr.toString());

		Sentence not = parser.parse("~C");
		ConjunctionOfClauses transformedNot = ConvertToCNF.convert(not);
	...
	public void testImplicationTransformation() {
		...
		ConjunctionOfClauses transformedImpl = ConvertToCNF.convert(impl);
	...
	public void testBiConditionalTransformation() {
		...
		ConjunctionOfClauses transformedBic = ConvertToCNF.convert(bic);
	...
	public void testTwoSuccessiveNotsTransformation() {
		...
		ConjunctionOfClauses transformed = ConvertToCNF.convert(twoNots);
		Assert.assertEquals("(A)", transformed.toString());
	}
	...
	public void testThreeSuccessiveNotsTransformation() {
		...
		ConjunctionOfClauses transformed = ConvertToCNF.convert(threeNots);
		Assert.assertEquals("(~A)", transformed.toString());
	}
	...
	public void testFourSuccessiveNotsTransformation() {
		...
		ConjunctionOfClauses transformed = ConvertToCNF.convert(fourNots);
		Assert.assertEquals("(A)", transformed.toString());
	}
	...
	public void testDeMorgan1() {
		...
		ConjunctionOfClauses transformed = ConvertToCNF.convert(dm);
	...
	public void testOrDistribution1() {
		...
		ConjunctionOfClauses transformed = ConvertToCNF.convert(or);
	...
	public void testAimaExample() {
		...
		ConjunctionOfClauses transformed = ConvertToCNF.convert(aimaEg);
	...
	public void testIssue78() {
		...
		ConjunctionOfClauses transformed = ConvertToCNF.convert(issue78Eg);
