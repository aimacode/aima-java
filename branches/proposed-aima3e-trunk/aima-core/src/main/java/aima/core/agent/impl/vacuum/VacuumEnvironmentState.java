...
public class VacuumEnvironmentState implements EnvironmentState {
	...
	public VacuumEnvironment.LocationState getLocationState(VacuumEnvironment.Location location) {
		return state.get(location);
	}
	
	public void setLocationState(VacuumEnvironment.Location location, VacuumEnvironment.LocationState s) {
