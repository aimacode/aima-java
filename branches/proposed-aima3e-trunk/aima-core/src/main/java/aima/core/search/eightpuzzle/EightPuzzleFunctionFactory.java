package aima.core.search.eightpuzzle;
	...
	private static class EPResultFunction implements ResultFunction {
		public Object result(Object s, Action a) {
			...
			if (EightPuzzleBoard.UP.equals(a) && board.canMoveGap(EightPuzzleBoard.UP)) {
				...
				newBoard.moveGapUp();
				return newBoard;
			} else if (EightPuzzleBoard.DOWN.equals(a) && board.canMoveGap(EightPuzzleBoard.DOWN)) {
				EightPuzzleBoard newBoard = new EightPuzzleBoard(board);
				newBoard.moveGapDown();
				return newBoard;
			} else if (EightPuzzleBoard.LEFT.equals(a) && board.canMoveGap(EightPuzzleBoard.LEFT)) {
				EightPuzzleBoard newBoard = new EightPuzzleBoard(board);
				newBoard.moveGapLeft();
				return newBoard;
			} else if (EightPuzzleBoard.RIGHT.equals(a) && board.canMoveGap(EightPuzzleBoard.RIGHT)) {
				EightPuzzleBoard newBoard = new EightPuzzleBoard(board);
