...
@RunWith(Suite.class)
@Suite.SuiteClasses( { AgentTestSuite.class, LearningTestSuite.class,
		LogicTestSuite.class, ProbabilityTestSuite.class,
		SearchTestSuite.class, UtilTestSuite.class })
