...
import aima.test.core.unit.search.eightpuzzle.EightPuzzleSuccessorFunctionTest;
...
import aima.test.core.unit.search.map.MapSuccessorFunctionTest;
...
import aima.test.core.unit.search.nqueens.NQueensSuccessorFunctionTest;
...
@Suite.SuiteClasses( { AssignmentTest.class, DomainsTest.class,
		...
		EightPuzzleBoardTest.class, EightPuzzleSuccessorFunctionTest.class,
		...
		MapSuccessorFunctionTest.class, MapTest.class, NQueensBoardTest.class,
		NQueensFitnessFunctionTest.class, NQueensGoalTestTest.class,
		NQueensSuccessorFunctionTest.class, LRTAStarAgentTest.class,
