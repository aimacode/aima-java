...
/**
 * Represents a percept in the vacuum environment.
 *
 * @author Ravi Mohan
 ...
 * @author Andrew Brown
 */
public class VacuumEnvironmentPercept extends DynamicPercept {
     ...
     *
     * @param agentLocation the agent's perception of the current location.
     * @param state the agent's perception of the current state.
     */
    public VacuumEnvironmentPercept(String agentLocation,
