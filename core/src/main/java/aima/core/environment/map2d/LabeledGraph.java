...
public class LabeledGraph<V, E> {
     ...
     * @param v
     *        the starting vertex
     * @return the immediate successor vertices which can be reached by following
     * the edges starting at the specified vertex.
     */
     ...
     * @param v
     *        the vertex to check.
     * @return true if the given vertex label is contained within the graph, false otherwise.
     */
