...
public interface Map2D {
     ...
     * @return  a list of the locations that are connected from the given location.
     */
    List<String> getLocationsLinkedTo(String fromLocation);

    /**
     * Get the travel distance between the two specified locations if they
     ...
     * @return the position of the specified location in the two dimensional space.
     */
