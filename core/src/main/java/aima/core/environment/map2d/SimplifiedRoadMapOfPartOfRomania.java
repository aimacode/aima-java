 ...
 *
 * The initialization method is declared static. So it can also be used to initialize
 * other specialized subclasses of {@link ExtendableMap2D} with road map data from Romania.
 * Location names, road distances and directions have been extracted from Artificial
 * Intelligence A Modern Approach (?? Edition), Figure ??, page ??. The
 * straight-line distances to Bucharest have been taken from Artificial
 * Intelligence A Modern Approach (?? Edition), Figure ??, page ??.
 *
