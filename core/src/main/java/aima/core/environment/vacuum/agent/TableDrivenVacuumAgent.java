...
public class TableDrivenVacuumAgent extends TableDrivenAgent<String, LocalPercept> {
	...
	public static Map<List<LocalPercept>, String> generatePartialTabulationOfActionFunction() {
		...
		perceptSequenceToAction.put(
				Arrays.asList(new LocalPercept(VacuumEnvironment.LOCATION_A, VacuumEnvironment.Status.Clean)),
				VacuumEnvironment.ACTION_RIGHT);
		perceptSequenceToAction.put(
				Arrays.asList(new LocalPercept(VacuumEnvironment.LOCATION_A, VacuumEnvironment.Status.Dirty)),
				VacuumEnvironment.ACTION_SUCK);
		perceptSequenceToAction.put(
				Arrays.asList(new LocalPercept(VacuumEnvironment.LOCATION_B, VacuumEnvironment.Status.Clean)),
				VacuumEnvironment.ACTION_LEFT);
		perceptSequenceToAction.put(
				Arrays.asList(new LocalPercept(VacuumEnvironment.LOCATION_B, VacuumEnvironment.Status.Dirty)),
				VacuumEnvironment.ACTION_SUCK);
		...
		perceptSequenceToAction.put(
				Arrays.asList(new LocalPercept(VacuumEnvironment.LOCATION_A, VacuumEnvironment.Status.Clean),
						new LocalPercept(VacuumEnvironment.LOCATION_A, VacuumEnvironment.Status.Clean)),
				VacuumEnvironment.ACTION_RIGHT);
		perceptSequenceToAction.put(
				Arrays.asList(new LocalPercept(VacuumEnvironment.LOCATION_A, VacuumEnvironment.Status.Clean),
						new LocalPercept(VacuumEnvironment.LOCATION_A, VacuumEnvironment.Status.Dirty)),
				VacuumEnvironment.ACTION_SUCK);
		perceptSequenceToAction.put(
				Arrays.asList(new LocalPercept(VacuumEnvironment.LOCATION_A, VacuumEnvironment.Status.Clean),
						new LocalPercept(VacuumEnvironment.LOCATION_B, VacuumEnvironment.Status.Clean)),
				VacuumEnvironment.ACTION_LEFT);
		perceptSequenceToAction.put(
				Arrays.asList(new LocalPercept(VacuumEnvironment.LOCATION_A, VacuumEnvironment.Status.Clean),
						new LocalPercept(VacuumEnvironment.LOCATION_B, VacuumEnvironment.Status.Dirty)),
				VacuumEnvironment.ACTION_SUCK);
		// 2
		perceptSequenceToAction.put(
				Arrays.asList(new LocalPercept(VacuumEnvironment.LOCATION_A, VacuumEnvironment.Status.Dirty),
