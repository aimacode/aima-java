 ...
 */
public class OnlineSearchProblem<A> {
	 ...
	 */
	public OnlineSearchProblem(ActionsFunction<A> actionsFunction,
			GoalTest goalTest) {
		this(actionsFunction, goalTest, new DefaultStepCostFunction<A>());
	}
	 ...
	 */
	public OnlineSearchProblem(ActionsFunction<A> actionsFunction,
			GoalTest goalTest, StepCostFunction<A> stepCostFunction) {
