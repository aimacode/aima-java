...
public class Problem<A> {
	...
	protected ActionsFunction<A> actionsFunction;

	protected ResultFunction<A> resultFunction;

	protected GoalTest goalTest;

	protected StepCostFunction<A> stepCostFunction;
	 ...
	 */
	public Problem(Object initialState, ActionsFunction<A> actionsFunction,
			ResultFunction<A> resultFunction, GoalTest goalTest) {
		this(initialState, actionsFunction, resultFunction, goalTest,
				new DefaultStepCostFunction<A>());
	}
	...
	public Problem(Object initialState, ActionsFunction<A> actionsFunction,
			ResultFunction<A> resultFunction, GoalTest goalTest,
			StepCostFunction<A> stepCostFunction) {
	 ...
	 */
	public ActionsFunction<A> getActionsFunction() {
	 ...
	 */
	public ResultFunction<A> getResultFunction() {
	 ...
	 */
	public StepCostFunction<A> getStepCostFunction() {
