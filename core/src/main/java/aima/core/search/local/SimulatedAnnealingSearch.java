...
import aima.core.util.extend.Util;
 ...
 */
public class SimulatedAnnealingSearch<A> extends NodeExpander<A> implements Search<A> {
	...
	private double getValue(Problem<A> p, Node<A> n) {
