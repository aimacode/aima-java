 ...
 */
public interface EnvironmentView<A,P> {
	/**
	 ...
	 *            to the Environment.
	 */
	void agentAdded(Agent<A,P> agent, EnvironmentState resultingState);
	 ...
	 *            the Environment.
	 */
	void agentActed(Agent<A,P> agent, A action, EnvironmentState resultingState);
}
