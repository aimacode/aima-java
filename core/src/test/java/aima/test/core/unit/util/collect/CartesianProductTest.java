package aima.test.core.unit.util.collect;
...
public class CartesianProductTest {
    ...
    public void testSpliteratorEstimateSize() {
        ...
        Assert.assertEquals(9,
                new CartesianProduct<>(String.class, new ArrayList<List<? extends String>>(){{
                    add(new ArrayList<String>() {{
                        add("1e1");
                        add("1e2");
                        add("1e3");
        ...
        Assert.assertEquals(Long.MAX_VALUE,
                new CartesianProduct<>(Integer.class, listOfListOfElements)
                        .spliterator().estimateSize());
    }
    ...
    public void testSpliteratorCharacteristics() {
        ...
        Assert.assertEquals(splor1.characteristics(), (Spliterator.DISTINCT | Spliterator.NONNULL | Spliterator.IMMUTABLE | Spliterator.SIZED | Spliterator.SUBSIZED));
        ...
        splor1 = new CartesianProduct<>(String.class, listOfListOfElements)
                .spliterator();
        Assert.assertEquals(splor1.characteristics(), (Spliterator.DISTINCT | Spliterator.NONNULL | Spliterator.IMMUTABLE));

        splor2 = splor1.trySplit();
        Assert.assertEquals(splor1.characteristics(), (Spliterator.DISTINCT | Spliterator.NONNULL | Spliterator.IMMUTABLE | Spliterator.SIZED | Spliterator.SUBSIZED));
        Assert.assertEquals(splor2.characteristics(), (Spliterator.DISTINCT | Spliterator.NONNULL | Spliterator.IMMUTABLE | Spliterator.SIZED | Spliterator.SUBSIZED));
    }
