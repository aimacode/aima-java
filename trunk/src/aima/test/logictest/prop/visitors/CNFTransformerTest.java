...
public class CNFTransformerTest extends TestCase {
	...
	public void testBiConditionalTransformation(){
		...
		Sentence expected  = (Sentence)parser.parse("(((NOT A) OR B)  AND ((NOT B) OR A)) ");
	...
	public void testFourSuccessiveNotsTransformation(){
		Sentence fourNots = (Sentence)parser.parse("(NOT (NOT (NOT (NOT A))))");
		Sentence expected  = (Sentence)parser.parse("A");
	...
	public void testAimaExample(){
		...
		Sentence expected = (Sentence)parser.parse(" (  (  ( NOT B11 )  OR  ( P12 OR P21 ) ) AND  (  ( B11 OR  ( NOT P12 )  ) AND  ( B11 OR  ( NOT P21 )  ) ) )");
