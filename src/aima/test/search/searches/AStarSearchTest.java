...
public class AStarSearchTest extends TestCase {
 public void testAStarSearch(){
	 //added to narrow down bug report filed by L.N.Sudarshan of Thoughtworks and Xin Lu of UCI
	 try {
		 //EightPuzzleBoard extreme = new EightPuzzleBoard(new int[] {2,0,5,6,4,8,3,7,1});
		//EightPuzzleBoard extreme = new EightPuzzleBoard(new int[] {0,8,7,6,5,4,3,2,1});
