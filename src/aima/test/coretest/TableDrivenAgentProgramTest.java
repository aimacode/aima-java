...
public class TableDrivenAgentProgramTest extends TestCase {
	...
	public void setUp() {		
		...
		perceptSequenceActions.put(new PerceptSequence(new Percept("key1", "value1")), "action1");
		perceptSequenceActions.put(new PerceptSequence(new Percept("key1", "value1"), new Percept("key1", "value2")), "action2");
		perceptSequenceActions.put(new PerceptSequence(new Percept("key1", "value1"), new Percept("key1", "value2"), new Percept("key1", "value3")), "action3");
		
		agent = new TestAgent(new TableDrivenAgentProgram(perceptSequenceActions));
	}	
