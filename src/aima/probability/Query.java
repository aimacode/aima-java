...
public class Query {
	...
	public Query(String queryVariable, String[] evidenceVariables, boolean[] evidenceValues) {
		this.queryVariable = queryVariable;
		this.evidenceVariables  = new Hashtable<String, Boolean>();
		for (int i=0;i<evidenceVariables.length;i++){
			this.evidenceVariables.put(evidenceVariables[i],new Boolean(evidenceValues[i]));
		}		
	}
