...
public class EightPuzzleDemo {
	...
	private static EightPuzzleBoard myCustom =
...
//		eightPuzzleAStarNullHeuristic();				// h = 0
//		eightPuzzleAStarWeightedMisplaced();			// h1 -> wighted misplaced (2^i per misplaced tile)
		eightPuzzleAStarWeightedManhattan();			// h2 -> weighted manhattan
//		eightPuzzleAStarWeightedNonConsistent();		// h3
//		eightPuzzleAStarWeightedEpsilonManhattan();		// (1+epsilon) * h2
