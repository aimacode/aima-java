 ...
 * the sample space &Omega;. ProbabilityModel only supports a finite count of
 * random variables.
 * 
...
public interface ProbabilityModel {
	 ...
	 *         &sum;<sub>&omega; &isin; &Omega;</sub> P(&omega;) = 1, false
	 *         otherwise.
	 */
	boolean isValid();
	 ...
	 * <br>
	 * which holds whenever P(b) > 0. This can be rewritten in a different form
	 * called the <b>product rule</b>: <br>
	 * <br>
	 ...
	 *         atomic variable/value pairs this probability model can take on.
	 */
	List<RandomVariable> getRepresentation();
}